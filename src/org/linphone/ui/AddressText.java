...
public class AddressText extends EditText implements AddressType {
	...
	public CountryCodeLenthListener ccListener;
	...
	public void setCountryCodeListener(CountryCodeLenthListener listener){
		ccListener = listener;
	}
	...
	protected void onTextChanged(CharSequence text, int start, int before,
		...
		OnCountryCode(((start+1) ==7) ,text.toString() );
...
//		setTextSize(TypedValue.COMPLEX_UNIT_PX, size);
	...
	public interface CountryCodeLenthListener{
		public abstract void gotCountryCode(boolean istrue, String text);
	}
	
	private void OnCountryCode(boolean istrue, String text){
		if(ccListener != null){
			ccListener.gotCountryCode(istrue, text);
		}
	}
}
