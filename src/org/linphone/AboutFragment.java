...
public class AboutFragment extends Fragment implements OnClickListener {
	...
	private final String htmltext = "9 BD MENDES FRANCE <br/>44700 ORVAULT<br/><br/>"+
		"Immatriculé sous le numéro 791 119 134 au registre du commerce et des sociétés de Nantes."+
        "Le contenu de ce site respecte les lois en vigueur. Les utilisateurs disposent d’un droit d’accès, de modification, de rectification et de suppression des données personnelles les concernant conformément à la loi libertés et informatique du 6 janvier 1978."+
		"<br/>Les contenus du site www.africallshop.com relèvent de la législation française et internationale sur les droits d’auteur et la propriété intellectuelle."+
        "<br/>Tous droits de reproduction sur tout support sont réservés.";
