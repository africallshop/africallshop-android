...
//	}
	...
	public static String getPictUriName(Context context, String phoneNumber) {
	    ContentResolver cr = context.getContentResolver();
	    Uri uri = Uri.withAppendedPath(PhoneLookup.CONTENT_FILTER_URI, Uri.encode(phoneNumber));
	    ...
	    try {
		    ...
		    if(cursor.moveToFirst()) {
		        pictureUri = cursor.getString(cursor.getColumnIndex(PhoneLookup.PHOTO_URI));
		    }
...
//	    	Cursor cursor = cr.query(uri, new String[]{"photo_uri" }, null, null, null);
//		    if (cursor == null) {
//		        return null;
//		    }
//		    String pictureUri = null;
//		    if(cursor.moveToFirst()) {
//		        pictureUri = cursor.getString(cursor.getColumnIndex("photo_uri"));
//		    }
//	
//		    if(cursor != null && !cursor.isClosed()) {
//		        cursor.close();
