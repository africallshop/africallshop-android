...
public class RestClient {
	...
	public void execute(RequestMethod method)
	    throws Exception, ConnectionPoolTimeoutException,ConnectTimeoutException,SocketTimeoutException {
		switch (method) {
			case GET: {
	...
	private void executeRequest(HttpUriRequest request, String url) {
		...
		HttpConnectionParams.setConnectionTimeout(params, Config.HTTP_CONNECTION_TIMEOUT * 1000);
		HttpConnectionParams.setSoTimeout(params, Config.HTTP_DATA_TIMEOUT * 1000);
